...
export const logIntegracionesEcommerce = createLogger({
    format: customFormat,
    transports: [
        new transports.File({
            maxsize: +MAX_SIZE_LOG,
            maxFiles: +MAX_FILE_LOG,
            filename: `${__dirname}/../../logs/integracion_ecommerce.log`
        }),
...
export const logCrm = createLogger({
    format: customFormat,
    transports: [
        new transports.File({
            maxsize: +MAX_SIZE_LOG,
            maxFiles: +MAX_FILE_LOG,
            filename: `${__dirname}/../../logs/databaseCRM.log`
        }),
